...
$tuna$tmpl$units$condition$ClassAction$$.prototype.apply = function $$tuna$tmpl$units$condition$ClassAction$$$$apply$($element$$38$$, $testResult$$) {
  $tuna$dom$setClassExist$$($element$$38$$, this.$_data$, $testResult$$)
};
...
function $JSCompiler_StaticMethods___applyUser$$($JSCompiler_StaticMethods___applyUser$self$$, $user$$2$$) {
  ...
  if($user$$2$$.$role$ !== $model$record$User$$.$ROLE_BAKERY$) {
...
$ProfileController$$.prototype.$_initActions$ = function $$ProfileController$$$$$_initActions$$() {
  var $changePasswordPopup$$ = $JSCompiler_StaticMethods_getModuleInstanceByName$$(this.$_container$, "popup", "change-password");
  $JSCompiler_StaticMethods_getModuleInstanceByName$$(this.$_container$, "button", "change-password").addEventListener("click", function() {
    $changePasswordPopup$$.open()
  });
  $JSCompiler_StaticMethods_getModuleInstanceByName$$(this.$_container$, "form", "change-password").addEventListener("result", function() {
...
$model$record$Partner$$.prototype.$populate$ = function $$model$record$Partner$$$$$populate$$($data$$44$$) {
  $model$record$User$$.prototype.$populate$.call(this, $data$$44$$);
...
$Recipe$$.prototype.$populate$ = function $$Recipe$$$$$populate$$($data$$46$$) {
  this.id = $data$$46$$.id;
  this.$bakeryId$ = $data$$46$$.bakery_id;
  this.name = $data$$46$$.name;
  this.$desc$ = $data$$46$$.desc;
...
$Delivery$$.prototype.$populate$ = function $$Delivery$$$$$populate$$($data$$48$$) {
  this.$date$ = new Date(1E3 * $data$$48$$.date);
  this.$address$ = $data$$48$$.address;
  this.$comment$ = $data$$48$$.comment;
  this.message = $data$$48$$.message
};
...
$Client$$.prototype.$populate$ = function $$Client$$$$$populate$$($data$$50$$) {
  this.name = $data$$50$$.name;
  this.$email$ = $data$$50$$.email;
  this.$phone$ = $data$$50$$.phone;
  this.$network$ = $data$$50$$.network;
  this.$networkId$ = $data$$50$$.network_id
};
...
$Payment$$.prototype.$populate$ = function $$Payment$$$$$populate$$($data$$52$$) {
  this.$paymentMethod$ = $data$$52$$.payment_method;
  this.$decorationPrice$ = $data$$52$$.decoration_price || 0;
  this.$deliveryPrice$ = $data$$52$$.delivery_price || 0;
  this.$recipePrice$ = $data$$52$$.recipe_price || 0
};
...
$Dimension$$.prototype.$populate$ = function $$Dimension$$$$$populate$$($data$$54$$) {
  this.id = $data$$54$$.id;
  this.$weight$ = $data$$54$$.weight;
  this.shape = $data$$54$$.shape;
  this.$ratio$ = $data$$54$$.ratio;
  this.$personsCount$ = $data$$54$$.persons_count
};
...
function $Order$$($data$$57$$) {
  this.id = "";
  this.index = 0;
  this.$delivery$ = this.$client$ = this.$payment$ = this.$cake$ = this.$recipe$ = this.$partner$ = this.$bakery$ = this.$date$ = $JSCompiler_alias_NULL$$;
...
$Order$$.prototype.$populate$ = function $$Order$$$$$populate$$($data$$58$$) {
  this.id = $data$$58$$.id;
  this.$cake$ = new $Cake$$($data$$58$$.cake);
  this.$bakery$ = new $Bakery$$($data$$58$$.bakery);
  this.$client$ = new $Client$$($data$$58$$.client);
  this.$recipe$ = new $Recipe$$($data$$58$$.recipe);
  this.$payment$ = new $Payment$$($data$$58$$.payment);
  this.$delivery$ = new $Delivery$$($data$$58$$.delivery);
  this.$partner$ = new $model$record$Partner$$($data$$58$$.partner);
  this.status = $data$$58$$.status;
  this.$paymentStatus$ = $data$$58$$.payment_status;
  this.$deliveryStatus$ = $data$$58$$.delivery_status;
...
$City$$.prototype.$populate$ = function $$City$$$$$populate$$($data$$60$$) {
  this.id = $data$$60$$.id;
...
function $model$record$Decoration$$($data$$61$$) {
  ...
  $tuna$model$Record$$.call(this, $data$$61$$)
}
$tuna$utils$extend$$($model$record$Decoration$$, $tuna$model$Record$$);
$model$record$Decoration$$.prototype.$populate$ = function $$model$record$Decoration$$$$$populate$$($data$$62$$) {
  this.id = $data$$62$$.id;
  this.name = $data$$62$$.name;
  this.$imageUrl$ = $data$$62$$.image_url;
  this.$isAutorotate$ = $data$$62$$.is_autorotate
};
